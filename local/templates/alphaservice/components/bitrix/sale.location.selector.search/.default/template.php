...
<?else:?>
	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-sls <? if($arResult['MODE_CLASSES'] <> ''): ?> <?= $arResult['MODE_CLASSES'] ?><? endif?>">
      ...
      <input type="text" placeholder="Ваш город..." onfocusin="this.placeholder = ''" onfocusout="this.placeholder = 'Ваш город...'" autocomplete="off" name="<?=$arParams['INPUT_NAME']?>" value="<?=$arResult['VALUE']?>" class="dropdown-field">
